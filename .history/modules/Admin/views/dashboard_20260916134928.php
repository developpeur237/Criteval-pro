  ...
  <main class="main-content" id="mainContent">
    ...
    <div class="dash-module" id="module-projets">
      <div class="module-header">
        ...
        <div class="module-actions">
          <button type="button" class="btn btn-secondary" onclick="$('#modalNewProject').addClass('open')"><i class="fas fa-plus"></i> Nouvelle organisation</button>
        </div>
      </div>
      ...
      <div class="projects-grid legacy-project-grid" style="display:none">
        ...
        <button type="button" class="project-card" onclick="$('#modalNewProject').addClass('open')" style="border:2px dashed rgba(46,175,125,0.3);display:flex;align-items:center;justify-content:center;min-height:280px;cursor:pointer;transition:all 0.3s;width:100%;color:inherit" onmouseover="this.style.background='rgba(46,175,125,0.05)'" onmouseout="this.style.background='var(--neutral-dark2)'">
  ...
  <div class="modal organisation-edit-modal">
    ...
    <form method="post" action="<?= BASE_URL ?>/admin/projects" enctype="multipart/form-data">
      <div class="modal-body organisation-modal-body">
        ...
        <div class="organisation-modal-grid" style="display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:12px">
          ...
          <label>Nom du responsable<input name="contact_name" class="form-input-dark"></label>
          <label>Téléphone<input type="tel" name="contact_phone" class="form-input-dark"></label>
          <label>E-mail de contact<input type="email" name="contact_email" class="form-input-dark"></label>
          ...
          <label>Pays d’appartenance *<input required name="country_code" class="form-input-dark" maxlength="5" placeholder="ML"></label>
          <label>Nombre de projets<input type="number" min="0" name="project_count" class="form-input-dark"></label>
          <label>Zone d’intervention<input name="intervention_zone" class="form-input-dark"></label>
          <label>Budget annuel / demandé (FCFA)<input type="number" min="0" step="0.01" name="budget_requested" class="form-input-dark"></label>
          <label>Durée d’activité / projet (mois)<input type="number" min="1" name="duration_months" class="form-input-dark"></label>
          ...
          <label>Logo de l’organisation<input type="file" name="logo" class="form-input-dark" accept="image/jpeg,image/png,image/webp,image/gif"><small>JPG, PNG, WEBP ou GIF, 2 Mo maximum.</small></label>
        </div>
        <label>Présentation / description détaillée<textarea name="description" class="form-input-dark" rows="4" placeholder="Présentez les activités, réalisations et résultats de votre organisation."></textarea></label>
      </div>
...
.organisation-edit-modal{width:min(920px,96vw);max-width:920px;max-height:min(900px,92vh);display:flex;flex-direction:column;overflow:hidden;background:#202031;border-color:rgba(255,255,255,.13);box-shadow:0 24px 80px rgba(0,0,0,.45)}
...
.organisation-edit-modal .modal-body{max-height:none;overflow-y:auto;padding:24px 28px 20px}
.organisation-edit-modal .organisation-modal-grid{display:grid!important;grid-template-columns:repeat(2,minmax(0,1fr))!important;gap:16px 18px!important}
.organisation-edit-modal .organisation-modal-body label{color:rgba(255,255,255,.64);font-size:12px;font-weight:600;gap:7px;margin:0}
...
.organisation-edit-modal textarea.form-input-dark{line-height:1.55;margin-top:18px;min-height:112px;resize:vertical}
