...
CREATE TABLE projects (
  ...
  description TEXT, objectives TEXT, status TEXT NOT NULL DEFAULT 'draft'
...
CREATE TABLE criteria (
  ...
  order_index INTEGER NOT NULL DEFAULT 0, FOREIGN KEY (project_id) REFERENCES projects(id) ON DELETE CASCADE
);
CREATE TABLE forms (
