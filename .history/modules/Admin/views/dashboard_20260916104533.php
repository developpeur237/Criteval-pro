...
<div class="modal-overlay" id="modalNewProject" onclick="if(event.target===this)$(this).removeClass('open')">
  <div class="modal">
    <div class="modal-header">
      <div class="modal-title"><i class="fas fa-building" style="color:var(--secondary);margin-right:8px"></i> Nouvelle organisation</div>
    ...
    <form method="post" action="<?= BASE_URL ?>/admin/projects" enctype="multipart/form-data">
      ...
      <div class="modal-footer">
        ...
        <button class="btn btn-secondary" type="submit"><i class="fas fa-check"></i> Enregistrer l’organisation</button>
      </div>
    </form>
  </div>
</div>
