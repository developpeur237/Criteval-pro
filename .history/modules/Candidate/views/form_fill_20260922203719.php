...
<body>
  <header class="pub-nav">
    ...
    <div class="nav-actions">
      <a class="btn btn-ghost btn-sm" href="<?= BASE_URL ?>/admin/login">
        <i class="fa fa-lock"></i> Connexion Admin
      </a>
      <a class="btn btn-secondary btn-sm" href="<?= BASE_URL ?>/candidate">
        <i class="fa fa-file-alt"></i> Espace Candidat
      </a>
    </div>
  </header>
