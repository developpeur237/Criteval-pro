...
.training-kpi-grid { grid-template-columns: repeat(4, minmax(0, 1fr)); gap: 12px; width: 100%; max-width: 780px; overflow: hidden; justify-self: start; margin-right: auto; margin-top: 28px; }
