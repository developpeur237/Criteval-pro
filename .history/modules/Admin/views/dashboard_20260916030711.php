        ...
        overlay.innerHTML = `
          <div class="modal" role="dialog" aria-modal="true" aria-labelledby="criteriaEditTitle">
            ...
            <form class="modal-body" id="criteriaEditForm">
              ...
              <div style="display:grid;grid-template-columns:1fr 1fr;gap:10px">
                <label class="form-label">Coefficient<input class="form-input-dark" name="weight" type="number" min="0" step="0.25"></label>
                <label class="form-label">Note maximale<input class="form-input-dark" name="max_score" type="number" min="0" step="0.5"></label>
              </div>
