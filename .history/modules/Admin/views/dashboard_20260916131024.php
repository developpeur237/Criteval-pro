...
<style>
.organisation-preview-overlay{align-items:center;backdrop-filter:blur(7px);background:rgba(5,12,18,.78);display:flex;justify-content:center;padding:5vh 5vw;z-index:1200}
