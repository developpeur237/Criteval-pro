...
-- Utilisateurs (superadmin, admin, user, visitor)
CREATE TABLE users (
  ...
  role ENUM('superadmin', 'admin', 'user', 'visitor') DEFAULT 'admin',
...
CREATE TABLE projects (
  ...
  legal_status VARCHAR(20) NOT NULL DEFAULT 'non_legal',
...
(3, 'Candidature — Jeunes entrepreneurs', 'Formulaire de candidature pour les jeunes entrepreneurs informels du Sénégal.', 3, '{"fields":[{"type":"text","label":"Nom du porteur"},{"type":"text","label":"Secteur d’activite"},{"type":"textarea","label":"Impact previsionnel"}]}', 'published', 1, NOW()),
(4, 'Candidature — Éducation numérique', 'Formulaire de candidature pour l’éducation numérique des filles rurales.', 4, '{"fields":[{"type":"text","label":"Ecole / ONG"},{"type":"text","label":"Nombre de filles cibles"},{"type":"textarea","label":"Plan de durabilite"}]}', 'published', 1, NOW()),
(5, 'Candidature — Semences locales', 'Formulaire de candidature pour le renforcement de la sécurité alimentaire.', 5, '{"fields":[{"type":"text","label":"Cooperative agricole"},{"type":"textarea","label":"Varietes de semences"},{"type":"number","label":"Metres carres de production"}]}', 'draft', 1, NOW()),
