      ...
      <form id="requestOtpForm" style="margin-top: 22px;">
        <div class="candidate-grid">
          ...
          <div class="field">
            ...
            <input id="accessCountry" name="country_code" list="candidateCountryOptions" required maxlength="25" placeholder="Saisir un pays">
            <datalist id="candidateCountryOptions">
              <?php foreach ($countryOptions as $option): ?>
                <option value="<?= e((string) $option) ?>"></option>
              <?php endforeach; ?>
            </datalist>
          </div>
        </div>
