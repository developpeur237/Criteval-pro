  ...
  <div class="candidate-shell">
    ...
    <div class="candidate-body">
      <main class="candidate-column-main">
        ...
        <section class="candidate-card">
          <div class="candidate-section-title"><span class="candidate-step">3</span> Documents requis</div>
          <div class="candidate-upload">
            <label class="candidate-label">Présentation du projet (PDF) <span class="req">*</span></label>
            <p>Glissez votre PDF ici ou <span class="candidate-link">cliquez pour sélectionner</span></p>
            <p class="candidate-upload-hint">PDF uniquement — Max 10 Mo</p>
            <div class="upload-chip"><i class="fas fa-file-pdf"></i> presentation_projet.pdf <i class="fas fa-check-circle"></i></div>
          </div>
        </section>
      </main>
