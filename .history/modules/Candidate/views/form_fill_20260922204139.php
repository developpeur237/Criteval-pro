...
<body>
  <header class="pub-nav">
    ...
    <ul class="nav-links">
      ...
      <li><a href="<?= BASE_URL ?>/candidate">Candidature</a></li>
      <li><a href="<?= BASE_URL ?>/dashboard">Dashboard</a></li>
      <li><a class="nav-action btn btn-ghost btn-sm" href="<?= BASE_URL ?>/admin/login"><i class="fa fa-lock"></i> Connexion Admin</a></li>
      <li><a class="nav-action btn btn-secondary btn-sm" href="<?= BASE_URL ?>/candidate"><i class="fa fa-file-alt"></i> Espace Candidat</a></li>
    </ul>
  </header>
