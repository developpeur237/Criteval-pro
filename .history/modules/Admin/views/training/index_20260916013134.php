...
<style>.admin-stub{max-width:1100px;margin:30px auto;padding:24px}.admin-form{margin:20px 0 32px;padding:20px;background:#fff;border:1px solid #dde1e7;border-radius:12px}.admin-form label{display:flex;flex-direction:column;gap:6px;margin-bottom:14px;color:#2c3e50;font-weight:600}.admin-form input,.admin-form textarea{padding:10px;border:1px solid #dde1e7;border-radius:8px;font:inherit;font-weight:400}.data-table{width:100%;border-collapse:collapse;background:#fff}.data-table th,.data-table td{padding:12px;text-align:left;border-bottom:1px solid #dde1e7;vertical-align:top}</style>
