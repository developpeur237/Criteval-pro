...
.training-main-grid { display: grid; grid-template-columns: minmax(0, 1.55fr) minmax(320px, .95fr); gap: 20px; margin-bottom: 20px; margin-top: -171px; align-items: start; }
