...
let chartInstances = {};
const submissionChartPeriods = ['1m', '3m', '6m', '1a', 'tout'];
...
function initCharts() {
  ...
  if (ctx1) {
    chartInstances.submissions = new Chart(ctx1, {
      type: 'line',
      data: {
        labels: overviewData.chart_ranges?.['6m']?.labels || [],
        datasets: [{
          label: 'Soumissions',
          data: overviewData.chart_ranges?.['6m']?.totals || [],
          borderColor: '#2EAF7D',
          ...
          label: 'Évaluées',
          data: overviewData.chart_ranges?.['6m']?.evaluated || [],
          borderColor: '#F5A623',
