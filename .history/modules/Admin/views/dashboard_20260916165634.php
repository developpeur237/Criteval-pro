    ...
    <div class="dash-module active" id="module-apercu">
      ...
      <div class="kpi-grid" id="kpiSortable">
        <div class="kpi-card widget-handle">
          ...
          <div class="kpi-val" data-target="<?= (int) ($overviewKpis['active_projects'] ?? 0) ?>">0</div>
        ...
        <div class="kpi-card widget-handle">
          ...
          <div class="kpi-val" data-target="<?= (int) ($overviewKpis['submissions'] ?? 0) ?>">0</div>
        ...
        <div class="kpi-card widget-handle">
          ...
          <div class="kpi-val" data-target="<?= (int) ($overviewKpis['evaluated'] ?? 0) ?>">0</div>
        ...
        <div class="kpi-card widget-handle">
          ...
          <div class="kpi-val" data-target="<?= (int) ($overviewKpis['pending'] ?? 0) ?>">0</div>
