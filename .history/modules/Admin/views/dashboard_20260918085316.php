...
function initPlanningCountryPicker() {
  ...
  function render() {
    ...
    if (!selected.length) {
      ...
      selected.forEach(function (option) {
        ...
        remove.addEventListener('click', function (event) { event.stopPropagation(); option.querySelector('input').checked = false; option.classList.remove('is-selected'); render(); });
  ...
  options.forEach(function (option) {
    option.addEventListener('click', function (event) {
      if (event.target.tagName !== 'INPUT') option.querySelector('input').checked = !option.querySelector('input').checked;
      render();
    });
  });
