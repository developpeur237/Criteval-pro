...
.training-kpi-grid { grid-template-columns: repeat(4, minmax(0, 1fr)); gap: 12px; width: calc(100% * 2 / 3); max-width: calc(100% * 2 / 3); overflow: hidden; justify-self: start; margin-right: auto; }
