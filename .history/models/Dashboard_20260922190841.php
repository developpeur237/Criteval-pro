...
class Dashboard
{
    public static function overview(): array
    {
        ...
        $chartRanges['tout'] = self::buildAllTimeChartRange(Submission::allTimeMonthlyChartCounts());
        ...
        $criteriaRows = $pdo->query(
            'SELECT label, SUM(weight) AS weight
             FROM criteria
             GROUP BY id, label
             ORDER BY weight DESC, id ASC
             LIMIT 6'
        )->fetchAll();
        $criteria = array_map(static fn (array $row): array => [
        ...
        return [
            ...
            'pending_submissions' => Submission::forEvaluation(10),
