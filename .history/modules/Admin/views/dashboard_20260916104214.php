  ...
  <main class="main-content" id="mainContent">
    ...
    <div class="dash-module" id="module-projets">
      <div class="module-header">
        ...
        <div class="module-actions">
          <a class="btn btn-secondary" href="<?= BASE_URL ?>/admin/projects"><i class="fas fa-plus"></i> Nouvelle organisation</a>
        </div>
      </div>
      ...
      <div class="projects-grid">
        ...
        <a class="project-card" href="<?= BASE_URL ?>/admin/projects" style="border:2px dashed rgba(46,175,125,0.3);display:flex;align-items:center;justify-content:center;min-height:280px;cursor:pointer;transition:all 0.3s;text-decoration:none" onmouseover="this.style.background='rgba(46,175,125,0.05)'" onmouseout="this.style.background='var(--neutral-dark2)'">
