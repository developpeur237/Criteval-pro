        ...
        <div class="organisation-form-groups">
          ...
          <section class="organisation-form-group">
            ...
            <div class="organisation-modal-grid organisation-modal-grid-tracking">
              ...
              <label class="logo-field">Logo<input type="file" name="logo" class="form-input-dark" accept="image/jpeg,image/png,image/webp,image/gif"><small>JPG, PNG, WEBP ou GIF, 2 Mo max.</small></label>
            </div>
          </section>
        </div>
